...
import com.rick.dioandroidsantander.R
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindOnView(conta: Conta){
        ...
        findViewById<TextView>(R.id.tv_valor_saldo_limite).text = "R$ " + conta.limite
        findViewById<TextView>(R.id.tv_usuario).text = conta.cliente.nome
        findViewById<TextView>(R.id.tv_cartao_final_value).text = conta.cartao.numeroConta
    }
